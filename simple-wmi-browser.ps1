# A simple WMI Browser
# http://community.idera.com/powershell/powertips/b/tips/posts/simple-wmi-browser
...
function Find-WmiClass
{
    ...
    Where-Object {
        ...
        $containsMember = ((@($_.Properties. Name) -like "*$Keyword*").Count `
        -gt 0) -or ((@($_.Methods. Name) -like "*$Keyword*").Count -gt 0)
        # is the keyword in the class name, and is it an interesting type of
        # class?
        $containsClassName = $_.Name -like "*$Keyword*" `
        -and $_.Properties.Count -gt 2 -and $_. Name -notlike 'Win32_Perf*'
